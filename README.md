...
```shell
git clone https://github.com/labrunning/qubt
```
...
`hugo.yaml`:
```yaml
baseURL: 'https://labrunning.github.io/qubt'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/labrunning/qubt
  - link: https://github.com/labrunning/qubt#readme
...
`https://labrunning.github.io/qubt`